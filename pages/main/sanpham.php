...
<?php
	$sql_chitiet = "SELECT * FROM tbl_sanpham,tbl_danhmucsp WHERE tbl_sanpham.id_danhmuc=tbl_danhmucsp.id_danhmuc AND tbl_sanpham.id_sanpham='$_GET[id]' LIMIT 1";
...
<div class="wrapper_chitiet">
	...
	<form method="POST" action="pages/main/themgiohang.php?idsanpham=<?php echo $row_chitiet['id_sanpham'] ?>">
		<div class="chitiet_sanpham">
			...
			<p>Giá sp: <?php echo number_format($row_chitiet['dongia'],0,',','.').'vnđ' ?></p>
			<p>Số lượng sản phẩm: <?php echo $row_chitiet['soluong'] ?></p>
			<p>Danh mục sản phẩm: <?php echo $row_chitiet['tendanhmucsp'] ?></p>
