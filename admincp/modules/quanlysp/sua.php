...
?>
 <form method="POST" action="modules/quanlysp/xuly.php?idsanpham=<?php echo $row['id_sanpham'] ?>" enctype="multipart/form-data">
	  ...
	  <tr>
	  	<td>Giá sp</td>
	  	<td><input type="text" value="<?php echo $row['dongia'] ?>" name="dongia"></td>
	  </tr>
	  <tr>
	  	<td>Số lượng</td>
	  ...
	  <tr>
	    ...
	    <td>
	    	<select name="danhmucsp">
	    		...
	    		?>
	    		<option selected value="<?php echo $row_danhmuc['id_danhmuc'] ?>"><?php echo $row_danhmuc['tendanhmucsp'] ?></option>
	    		<?php
	    			}else{
	    		?>
	    		<option value="<?php echo $row_danhmuc['id_danhmuc'] ?>"><?php echo $row_danhmuc['tendanhmucsp'] ?></option>
	    		<?php
	    			}
	    		} 
	    		?>
